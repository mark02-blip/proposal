    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                animate={{ opacity: 1, }}
                transition={{ delay: .5 }}
                className="max-w-md text-center relative p-5 rounded-2xl bg-pink-700/20 border border-pink-500/15 text-foreground shadow-[0_0_20px_rgba(0,0,0,0.25)] backdrop-blur-md overflow-hidden mb-8"
                ref={scrollRef}
            >
                ...
                >
                    ...
                    {showCursor && <motion.span
                        ...
                        className="inline-block w-0.5 h-4 bg-pink-500 ml-0.5"
                    />}
                </motion.p>
            </motion.div>
